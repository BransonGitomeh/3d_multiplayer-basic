...
## Reviewer Notes
Thank you for this opportunity and interesting challenge 🚀🚀,

##### I have included tests for the backend endpoints, and a frontend client using create-react-app using simple bootstrap 5 for the ui
...
$ npm i
$ yarn start
# runs on 3001 as before, also runs production build of frontend on 127.0.0.1:8081
```

#### Backend tests
```
$ yarn test
# runs the 8 http tests using mocha, chai and chai-http
```
...
$ yarn start
# runs on 3000
# i got dependency issues running this several times, please use the served prod build to test
```

This is the root page

![Root page image](images/image.png)

Clients list is available, and balance

![Alt text](images/image-1.png)

As described in the requirements, you should select a deposit amount to deposit and select the contractor from our autocompletion on select

if there are no jobs available for the contractor this will be indicated in a warning

![Alt text](images/image-2.png)

![Alt text](images/image-3.png)

Both the Deposit and Pay calls have been implemented as sequelize TRANSACTIONS for atomicity 

and errors are displayed as simple alerts

![Alt text](images/image-4.png)

The admin endpoints have also been wrapped in a ui
